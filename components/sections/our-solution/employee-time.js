                            ...
                            <div className="about-3-txt mb-40">
                                {icon ?
                                    ...
                                    <>
                                        ...
                                        {/* Title */}
                                        <h2 className="h2-sm">Free up your <span className="yellow-color"> employees' time</span></h2>
                                        {/* List */}
                                        <ul className="txt-list">
                                            <li className="list-item">
                                                <p className="p-md" style={{fontSize: '27px'}}>Enable customers to place orders by themselves, enhancing service efficiency</p>
                                            </li>
                                            <li className="list-item">
                                                <p className="p-md" style={{fontSize: '27px'}}>Reduce menu inquiries with a detailed digital menu</p>
                                            </li>
                                            <li className="list-item">
                                                <p className="p-md" style={{fontSize: '27px'}}>Lower costs and optimize staff efficiency</p>
                                            </li>
                                        </ul>
                                    </>}
